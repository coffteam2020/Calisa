...
class IALocalStorage {
   ...
   * Set/get USER INFO
   */
  static setDeviceEmail = async (userInfo) => {
  	await IAStorageManager.setItem('email', userInfo);
  }

  static getDeviceEmail = async () => {
  	return await IAStorageManager.getItem('email');
  }
   /**
   * Set/get USER INFO
   */
  static setShowBiometrics = async (userInfo) => {
  	await IAStorageManager.setItem('bio', userInfo);
  }

  static getShowBiometrics = async () => {
  	return await IAStorageManager.getItem('bio');
  }
  /**
   * Set/get USER INFO
   */
  static setDevicePass = async (userInfo) => {
  	await IAStorageManager.setItem('pass', userInfo);
  }

  static getDevicePass = async () => {
  	return await IAStorageManager.getItem('pass');
  }
